package com.blazify.paxsenix

import android.content.Context
import com.blazify.music.betterlyrics.TTMLParser
import com.blazify.paxsenix.models.AppleMusicSearchResponse
import com.blazify.paxsenix.models.LyricsResponse

import com.blazify.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Blazify/$appVersion")
                }
