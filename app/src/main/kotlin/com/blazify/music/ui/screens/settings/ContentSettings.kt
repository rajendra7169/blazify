...
import com.blazify.music.constants.CountryCodeToName
...
import com.blazify.music.constants.LanguageCodeToName
import com.blazify.music.constants.LyricsProviderOrderKey
import com.blazify.music.constants.ProxyEnabledKey
import com.blazify.music.constants.ProxyPasswordKey
import com.blazify.music.constants.ProxyTypeKey
import com.blazify.music.constants.ProxyUrlKey
import com.blazify.music.constants.ProxyUsernameKey
...
import com.blazify.music.constants.ShowArtistDescriptionKey
import com.blazify.music.constants.ShowMostStatsPlaylistsKey
import com.blazify.music.constants.ShowArtistSubscriberCountKey
import com.blazify.music.constants.ShowMonthlyListenersKey
    ...
    LaunchedEffect(showMostStatsPlaylists) {
        if (!showMostStatsPlaylists) {
            database.withTransaction {
                clearPlaylist(com.blazify.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID)
                clearPlaylist(com.blazify.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID)
                delete(
                    com.blazify.music.db.entities.PlaylistEntity(
                        id = com.blazify.music.db.entities.PlaylistEntity.WEEKLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
                delete(
                    com.blazify.music.db.entities.PlaylistEntity(
                        id = com.blazify.music.db.entities.PlaylistEntity.MONTHLY_MOST_PLAYLIST_ID,
                        name = "",
                    ),
                )
            }
