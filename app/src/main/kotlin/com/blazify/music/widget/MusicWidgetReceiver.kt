...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.blazify.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.blazify.music.widget.LIKE"
        const val ACTION_NEXT = "com.blazify.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.blazify.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.blazify.music.widget.UPDATE_WIDGET"
    }
}
