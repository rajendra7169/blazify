...
import com.blazify.music.constants.AndroidAutoSectionsOrderKey
import com.blazify.music.constants.AndroidAutoYouTubePlaylistsKey
import com.blazify.music.ui.screens.settings.AndroidAutoSection
import com.blazify.music.ui.screens.settings.deserializeSections
import com.blazify.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.blazify.innertube.pages.HomePage.Section>()
