package com.blazify.music.discord
...
import com.blazify.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.blazify.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.blazify.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "blazifydiscord://oauth2/callback"
