...
val baseApplicationId = "com.blazify.music"
val applicationIdOverride = System.getenv("BLAZIFY_APPLICATION_ID")?.takeIf { it.isNotBlank() }
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Blazify Debug")
            }
            signingConfig =
