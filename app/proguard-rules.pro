...
# Since Blazify is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.blazify.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.blazify.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.blazify.music.utils.cipher.** { *; }
-keep class com.blazify.music.utils.potoken.** { *; }
...
-keep class com.blazify.music.models.PersistQueue { *; }
-keep class com.blazify.music.models.PersistPlayerState { *; }
-keep class com.blazify.music.models.QueueData { *; }
-keep class com.blazify.music.models.QueueType { *; }
-keep class com.blazify.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.blazify.music.cast.** { *; }
...
-keep class com.blazify.music.recognition.VibraSignature { *; }
-keepclassmembers class com.blazify.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.blazify.music.listentogether.proto.** { *; }
-keepclassmembers class com.blazify.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.blazify.shazamkit.models.** { *; }
-keepclassmembers class com.blazify.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.blazify.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.blazify.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.blazify.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
